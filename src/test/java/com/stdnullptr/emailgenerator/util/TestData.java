...
public final class TestData {
    ...
    private static Map<String, MultiValueMap<String, String>> createErrorTestEntry(final String expectedErrorMessage, final MultiValueMap<String, String> queryParams) {
        final Map<String, MultiValueMap<String, String>> testEntry = new HashMap<>();
        testEntry.put(expectedErrorMessage, queryParams);
        return testEntry;
    }

    private static Map<String, Map<String, String>> createInterpreterTestEntry(final String expectedResult, final Map<String, String> inputs) {
        final Map<String, Map<String, String>> testEntry = new HashMap<>();
